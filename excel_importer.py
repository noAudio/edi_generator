...
for row in worksheet['A']:
    ...
    textfile = open('{}_{}_CLAIM.txt'.format(
        records['PayerName'], records['PayerID']), 'a')
    textfile.write(edi_claim['Loop2000A/BillingProvider/Hierarchy/1/20/1'])
    textfile.write(edi_claim['Loop2010AA/BillingProvider/Name'])
    textfile.write(edi_claim['Loop2010AA/BillingProvider/InfoCont'])
    textfile.write(edi_claim['Loop2010AA/BillingProvider/StreetAddress'])
    textfile.write(edi_claim['Loop2010AA/BillingProvider/CityStateAndZip'])
    textfile.write(edi_claim['Loop2010AA/BillingProvider/Reference/TaxID/EIN'])
    textfile.write(edi_claim['Loop2010AA/BillingProvider/InformationContact'])
    textfile.write(edi_claim['Loop2010AB/BillingProvider/NM1/87/2'])
    textfile.write(edi_claim['Loop2010AB/BillingProvider/StreetAddress'])
    textfile.write(edi_claim['Loop2010AB/BillingProvider/CityStateAndZipCode'])
    textfile.close()
